...
export class SurveyForm extends React.Component<ISurveyFormProps, ISurveyFormState> {
    ...
    handleFirstNameChange(event: any): void {
        if ((event.target.value as string).trim().length < 2 || (event.target.value).trim().length > 25) {
            ...
            this.setState({ firstNameVS: "success" });
        }
    ...
    handleLastNameChange(event: any): void {
        if ((event.target.value as string).trim().length < 2 || (event.target.value as string).trim().length > 25) {
            ...
            this.setState({ lastNameVS: "success" });
        }
    ...
    handleAddressChange(event: any): void {
        if ((event.target.value as string).trim().length < 4 || (event.target.value as string).trim().length > 100) {
            ...
            this.setState({ addressVS: "success" });
        }
    ...
    handleCurrentPositionChange(event: any): void {
        if ((event.target.value as string).trim().length < 4 || (event.target.value as string).trim().length > 100) {
            ...
            this.setState({ currentPositionVS: "success" });
        }
    ...
    handleEmailChange(event: any): void {
        ...
        if (!regex.test((event.target.value as string))) {
            ...
            this.setState({ emailAddressVS: "success" });
        }
    ...
    handlePlaceOfStudyingChange(event: any): void {
        if ((event.target.value as string).trim().length < 3 || (event.target.value as string).trim().length > 100) {
            ...
            this.setState({ placeOfStudyingVS: "success" });
        }
    ...
    handleSpecialtyChange(event: any): void {
        if ((event.target.value as string).trim().length < 3 || (event.target.value as string).trim().length > 150) {
            ...
            this.setState({ specialtyVS: "success" });
        }
    ...
    checkValidationState() {
        if (this.state.firstNameVS !== "error" &&
            this.state.lastNameVS !== "error" &&
            this.state.ageVS !== "error" &&
            this.state.addressVS !== "error" &&
            this.state.isEmployedVS !== "error" &&
            this.state.currentPositionVS !== "error" &&
            this.state.phoneVS !== "error" &&
            this.state.emailAddressVS !== "error" &&
            this.state.skypeVS !== "error" &&
            this.state.placeOfStudyingVS !== "error" &&
            this.state.specialtyVS !== "error") {
    ...
    handleSubmit(event: any): void {
        ...
        xhr.open("POST", "Survey/SubmitSurvey", false);
        xhr.onload = function () {
        };
        xhr.send(data);
    ...
    render() {
        if (!this.state.isDone) {
            return <div className="container">
                <Form horizontal>
                    ...
                    <FormGroup controlId="surveyFormAddress" validationState={this.state.addressVS}>
                        ...
                        <Col sm={10}>
                            <FormControl type="text" onChange={this.handleAddressChange.bind(this)
                            } placeholder="Ivano-Frankivsk city" />
                        </Col>
                    </FormGroup>
                    ...
                    <FormGroup controlId="surveyFormCurrentPosition" validationState={this.state.currentPositionVS}>
                        ...
                        <Col sm={10}>
                            <FormControl type="text" onChange={this.handleCurrentPositionChange.bind(this)
                    ...
                    <FormGroup controlId="surveyFormPhone" validationState={this.state.phoneVS}>
                        ...
                        <Col sm={10}>
                            <FormControl type="text" onChange={this.handlePhoneChange.bind(this)
                            } placeholder="+380 66 666 6666" />
                        </Col>
                    </FormGroup>
                    ...
                    <FormGroup controlId="surveyFormSkype" validationState={this.state.skypeVS}>
                        ...
                        <Col sm={10}>
                            <FormControl type="text" onChange={this.handleSkypeChange.bind(this)
                            } placeholder="johnystark" />
                        </Col>
                    </FormGroup>
                    <hr />
                    ...
                    <FormGroup controlId="surveyFormPlaceOfStudying" validationState={this.state.placeOfStudyingVS}>
                        ...
                        <Col sm={10}>
                            <FormControl type="text" onChange={this.handlePlaceOfStudyingChange.bind(this)
                            } placeholder="IFNTUOG" />
                        </Col>
                    </FormGroup>
                    <FormGroup controlId="surveyFormSpecialty" validationState={this.state.specialtyVS}>
                        ...
                        <Col sm={10}>
                            <FormControl type="text" onChange={this.handleSpecialtyChange.bind(this)
                            } placeholder="Army Runner" />
                        </Col>
                    </FormGroup>
                    <hr />
                    ...
                    <FormGroup controlId="surveyFormOther">
                        ...
                        <Col sm={10}>
                            <FormControl componentClass="textarea" onChange={this.handleOtherInfoChange.bind(this)
                            } placeholder="Some borring text" />
                        </Col>
                    </FormGroup>
                    <hr />
                    <FormGroup>
                        <Col smOffset={2} sm={10}>
                            <Button type="submit" disabled={!this.state.isValid} onClick={this.handleSubmit.bind(this)}>
                                Submit
                           </Button>
                        </Col>
                    </FormGroup>
            ...
            return <div className="container">
                <h2>Thank you for you patience</h2>
            </div>;
        }
    }
}
